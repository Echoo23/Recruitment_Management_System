        ...
        <div class="hero">
            <div style="width: 100%; " class="row">
                ...
                <div style=" height: 100vh; color: black " class="col-md-6">
                    ...
                    <h4><form method="post" enctype="multipart/form-data">
                        <div>
                        <input type="file" name="file" id="file" require></input>
                        
                        <input type="submit" name="submit" value="Upload Resume" id="myButton">
