...
<head>
  ...
  <title> BDNiefes | Job Listings </title>
      ...
      <div style="width: 100%" class="row">
        <div class="col-md-9">
          ...
          <div class="container" style="padding-left:50px; padding-top:50px; padding-bottom:50px;">
            ...
            ?>
                <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #f2cc8f; padding-left:4px;"> Active Jobs: <?php echo $numberofusers; ?> </h3>
            <?php }
            } ?>
            <!--------------------------------------------------------------------------------------------->
