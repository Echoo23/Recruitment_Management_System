...
<div class="modal fade" id="empsignup" tabindex="-1" role="dialog" aria-labelledby="myEmployerModalLabel">
  <div class="modal-dialog" role="document">
          ...
          <div id="cd-empsignup"> 
            ...
            <div class="container" style="">
                ...
                <ul class="nav nav-tabs" style="width: 535px;">
                    ...
                    <li><a data-toggle="tab"  href="#menu1" class="ba"  >Applicant Register</a></li>
                </ul>
    ...
    <div id="menu1" class="tab-pane fade"  style="width: 50%;">
      <h3 style="color: white; padding-left: 30px;">Register as Applicant</h3>
      <form class="cd-form" method="post" action="registerJobseeker.php" enctype="multipart/form-data">
					...
					<p class="fieldset" style="padding-right: 30px;">
						<label class="image-replace cd-password" for="empsignup-password">Password</label>
                                        ...
                                        <p class="fieldset" style="padding-right: 30px;">
						<label class="image-replace cd-username" for="empsignup-username">Previous Job</label>
						<input class="full-width has-padding has-border" id="qlf" name="qlf" type="text" placeholder="Previous Job">
                                        ...
                                        <p class="fieldset" style="padding-right: 30px;">
                                         ...
                                         <label class="image-replace cd-username" for="empsignup-username">skills</label>
                                          <select type="text" name="skills" class="form-control" style="border-radius:0px; height: 50px;" placeholder="Category"> <?php include 'skillscategory.php'; ?>
                                </select>
					...
					<p class="form-group">
                                            <button id="regsubmit" name= "submit"class="full-width has-padding btn-success" style="padding:10px; background-color: #e9c46a;color:#1d3557;">Create account</button>
					</p>
